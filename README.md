...
- Métodos de pago: efectivo, transferencia y **pago combinado** (parte efectivo + parte transferencia, el cliente pone cuánto paga en cada uno) — quedan en estado `pendiente_*` hasta confirmación manual.
